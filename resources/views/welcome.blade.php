                                        ...
                                        <div class="card bg-dark text-center text-white p-4">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-group mb-4">
                                                    <li class="list-group-item">1 Hour of Surfing</li>
                                                    <li class="list-group-item">100 Mbps Speed</li>
                                                    <li class="list-group-item">Free Movies and Series</li>
                                                </ul>
                                                <button type="button" class="btn btn-white btn-block text-dark font-weight-bold animate-up-2"
                                                    tabindex="0"><span class="fas fa-money-check-alt"></span> Purchase </button>
                                            </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <div class="pricing-card mt-3">
                                        <div class="card bg-dark text-center text-white p-4">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-group mb-4">
                                                    <li class="list-group-item">6 Hours of Surfing</li>
                                                    <li class="list-group-item">100 Mbps Speed</li>
                                                    <li class="list-group-item">Free Movies and Series</li>
                                                </ul>
                                                <button type="button" class="btn btn-white btn-block text-dark font-weight-bold animate-up-2"
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <div class="pricing-card mt-3">
                                        <div class="card bg-dark text-center text-white p-4">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-group mb-4">
                                                    <li class="list-group-item">1 Day of Surfing</li>
                                                    <li class="list-group-item">100 Mbps Speed</li>
                                                    <li class="list-group-item">Free Movies and Series</li>
                                                </ul>
                                                <button type="button" class="btn btn-white btn-block text-dark font-weight-bold animate-up-2"
